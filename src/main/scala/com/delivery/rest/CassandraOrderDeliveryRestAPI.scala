...
import cats.Id
import com.delivery.dao.AssignmentDAO.AssignmentRepository
import com.delivery.dao.CourierDAO.CourierRepository
import com.delivery.dao.OrderDAO.OrderRepository
import com.delivery.domain.OrderDeliveryDomain.{Courier, CourierOptional, Order, OrderOptional}
...
object CassandraOrderDeliveryRestAPI extends HttpApp {
  ...
  val assignmentRepo = new AssignmentRepository
  val assignmentService = new AssignmentService(assignmentRepo)
  val courierRepo = new CourierRepository
